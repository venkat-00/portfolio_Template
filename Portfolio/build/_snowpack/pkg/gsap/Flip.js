      ...
      matrix = parentMatrix
        ...
        .multiply(
          toState.ctm
            ...
            : toState.matrix
        ); // root SVG elements have a ctm that we must factor out (for example, viewBox:"0 0 94 94" with a width of 200px would scale the internals by 2.127 but when we're matching the size of the root <svg> element itself, that scaling shouldn't factor in!)
...
var ElementState = /*#__PURE__*/ (function () {
  ...
  _proto2.update = function update(props, simple) {
    ...
    this.width = bbox
      ? bbox.width
      : _closestTenth(parseFloat(getProp("width", "px")) + 0.04); // round up to the closest 0.25 so that text doesn't wrap.
