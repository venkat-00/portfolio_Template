define("./workbox-2fdebd44.js", ["exports"], function (t) {
  "use strict";
  try {
  ...
  const c = {
    ...
    h = (t) =>
      [c.prefix, t, c.suffix].filter((t) => t && t.length > 0).join("-"),
    u = (t) => t || h(c.precache),
    l = (t) => t || h(c.runtime);
  function f(t, e) {
    const s = e();
  ...
  class L {
    ...
    addToCacheList(t) {
      ...
      for (const n of t) {
        ...
        if ((this.k.set(i, t), this.j.set(i, r), e.length > 0)) {
  ...
  function x(t) {
    ...
    !(function (t, e, n) {
      ...
      if ("string" == typeof t) {
        ...
        c = new i(({ url: t }) => t.href === s.href, e, n);
